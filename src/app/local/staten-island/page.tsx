      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        >
          <h1 className="text-5xl sm:text-6xl font-serif mb-6">
            Health & Wellness in <span className="gradient-text">Staten Island</span>
          </h1>
          <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
            Premium, tailored health & wellness coaching in Staten Island or online. Transform your well-being with personalized guidance.
          </p>
        </motion.section>
